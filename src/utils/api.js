let swagger = {
      ...
      'post': {
        ...
        'parameters': [
          ...
          },
          {
            'in': 'formData',
            'name': 'icon',
            'description': '用户头像 http://xiedian.oss-cn-hangzhou.aliyuncs.com/Logo/xiedian.png',
            'type': 'string'
          }
        ],
        'responses': {
  ...
  'tags': [
    ...
    {
      'name': 'xiedian_user',
      'description': 'XiedianUserController operations for XiedianFeedback\n'
    },
    {
      'name': 'xiedian_fixing',
